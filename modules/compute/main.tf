...
resource "aws_instance" "palworld_server" {
  ...
  iam_instance_profile = var.custom_palworldsettings_s3 == true && length(aws_iam_instance_profile.instance_profile) > 0 ? aws_iam_instance_profile.instance_profile[0].name : null
